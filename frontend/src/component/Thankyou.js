          ...
          <div className="site-wrap">
            ...
            <div className="bg-light py-3">
              <div className="container">
                <div className="row">
                  <div className="col-md-12 mb-0"><NavLink to="/adminindex">Home</NavLink> <span className="mx-2 mb-0">/</span> <strong className="text-black">Contact</strong></div>
                </div>
              </div>
            </div>  
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-12 text-center">
                    ...
                    <p><NavLink to="/shop" className="btn btn-sm btn-primary">Back to shop</NavLink></p>
                  </div>
                </div>
              </div>
            </div>
