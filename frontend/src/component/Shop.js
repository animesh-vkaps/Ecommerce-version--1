...
var Shop = ()=>{
  ...
  //Function for getting products according to category
  const getProductsCategory = async(_id)=>{
    try{
  ...
  const handleSearchSubmit = e => {
    ...
    const populateProducts =  () => {
      getProducts(limit, skip, keyword, cat)
    }
    setSkip(0)
    // populateProducts()
  }
  ...
  useEffect(()=>{
    const populateProducts = async () => {
      setTotalResults(await getProducts(limit, skip, keyword, cat))
    }
    populateProducts();
    getCategory();
          ...
          <div className="site-wrap">
            ...
            <div className="bg-light py-3">
              <div className="container">
                <div className="row">
                  <div className="col-md-12 mb-0"><NavLink to="/">Home</NavLink> <span className="mx-2 mb-0">/</span> <strong className="text-black">Shop</strong></div>
                </div>
              </div>
            </div>
                              ...
                              <div className="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                <div className="block-4 text-center border">
                                  <figure className="block-4-image">
                                    <NavLink to={`/Shopsingle/${item._id}`}><img src={item.productImage} alt="Image placeholder" className="img-fluid" /></NavLink>
                                  </figure>
                                  <div className="block-4-text p-4">
                                    <h3><NavLink to={`/Shopsingle/${item._id}`}>{item.name}</NavLink></h3>
                  ...
                  <div className="col-md-3 order-1 mb-5 mb-md-0">
                    <div className="border p-4 rounded mb-4">
                      ...
                      <ul className="list-unstyled mb-0">
                        {
                          category.map((cate)=>{
                           console.log(cate,"cataa")
                            return(
                             
                                <li  className="mb-1">
                                  <button className="d-flex btn btn-secondary "
                                     onClick={()=>getProducts(limit,skip,keyword, cate._id)}
